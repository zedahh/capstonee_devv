...
<div class="bhms-shell">
  ...
  <aside class="bhms-sidebar">
    ...
    <nav class="bhms-nav">
      ...
      <a href="../admin/lgu_contacts.php" class="bhms-nav-link active"><i class="fa-solid fa-address-book"></i><span>LGU Contacts</span></a>
      <?php endif; ?>
    </nav>
  ...
  <div class="bhms-main">
    <header class="bhms-topbar">
      ...
      <div class="bhms-topbar-title">LGU / Barangay Office Contacts</div>
...
<div class="container py-4">
  <div class="d-flex justify-content-between align-items-center mb-4">
    <h3><i class="fa-solid fa-address-book me-2" style="color:var(--bhms-green);"></i>LGU / Barangay Office Contacts</h3>
  ...
  <div class="card mb-4">
    <div class="card-body">
      <h5 class="card-title"><i class="fa-solid fa-user-plus me-2"></i>Add contact</h5>
  ...
  <table class="table table-striped">
    ...
    <tbody>
      ...
      <tr>
        <td><div class="contact-name-cell"><div class="contact-icon"><i class="fa-solid fa-user"></i></div><?= htmlspecialchars($c['contact_name']) ?></div></td>
