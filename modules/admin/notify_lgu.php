...
if (empty($contacts)) {
    ...
    $log->execute([$_SESSION['user_id'], "SMS notify attempted but no LGU contacts on file: $disease in Purok $purok"]);

    header('Location: ../dashboard/dashboard.php?sms_no_contacts=1');
    exit;
}
