...
<style>
  ...
  .form-check-input:checked { background-color: var(--bhms-blue); border-color: var(--bhms-blue); }
...
<div class="container py-4">
  <div class="d-flex justify-content-between align-items-center mb-4">
    <h3><i class="fa-solid fa-bullhorn me-2" style="color:var(--bhms-blue);"></i>Public Announcements</h3>
    <div>
