...
.btn-outline-primary { color: var(--bhms-blue-dark); border-color: var(--bhms-blue); }
  ...
  .bhms-toast-ok { display: block; margin-left: auto; margin-top: 0.9rem; border: none; background: linear-gradient(135deg, var(--bhms-success), var(--bhms-blue)); color: #fff; font-weight: 600; font-size: 0.8rem; padding: 0.4rem 1.1rem; border-radius: 8px; cursor: pointer; transition: filter 0.15s ease; }
