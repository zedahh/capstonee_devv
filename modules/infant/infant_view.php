...
<style>
  ...
  .infant-icon {
    ...
    background: linear-gradient(135deg, var(--bhms-teal), var(--bhms-blue));
    color: #fff; display: flex; align-items: center; justify-content: center;
    font-size: 0.75rem;
  }

  .status-badge-normal { background: var(--bhms-success-light); color: var(--bhms-green-dark); }
...
<div class="container py-4">
  <div class="d-flex justify-content-between align-items-center mb-4">
    <h3><i class="fa-solid fa-baby me-2" style="color:var(--bhms-green);"></i>Infant Monitoring</h3>
  ...
  <div class="card mb-4">
    <div class="card-body">
      ...
      <form method="POST" action="">
        ...
        <button type="submit" class="btn btn-primary mt-3"><i class="fa-solid fa-plus me-2"></i>Register infant</button>
      </form>
    </div>
  </div>
