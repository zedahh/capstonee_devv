<?php
/** @var PDO $pdo */
/** @var array $epi_schedule */
/** @var string $error */
/** @var array $infants */
/** @var array $mothers */
/** @var string $success */
if (!isset($infants)) { return; }
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
.bhms-nav::-webkit-scrollbar-button:vertical:end:increment {
  ...
  .infant-name-cell { display: flex; align-items: center; gap: 0.6rem; }
  .infant-icon {
...
<div class="bhms-shell">
  ...
  <aside class="bhms-sidebar">
    ...
    <nav class="bhms-nav">
      ...
      <a href="../infant/infant.php" class="bhms-nav-link active"><i class="fa-solid fa-baby"></i><span>Infant Monitoring</span></a>
  ...
  <div class="bhms-main">
    <header class="bhms-topbar">
      ...
      <div class="bhms-topbar-title">Infant Monitoring</div>
...
<div class="container py-4">
  <div class="d-flex justify-content-between align-items-center mb-4">
    <h3><i class="fa-solid fa-baby me-2" style="color:var(--bhms-blue);"></i>Infant Monitoring</h3>
    <a href="../dashboard/dashboard.php" class="btn btn-outline-secondary btn-sm">Back to dashboard</a>
  </div>

  <div class="card mb-4">
    <div class="card-body">
      <h5 class="card-title"><i class="fa-solid fa-baby-carriage me-2"></i>Register newborn</h5>
      <form method="POST" action="" id="infantForm">
        <div class="row g-3">
          <div class="col-md-4">
        ...
        <button type="submit" id="infantSubmitBtn" class="btn btn-primary mt-3"><i class="fa-solid fa-plus me-2"></i>Register infant</button>
      </form>
    </div>
  </div>
...
document.getElementById('infantForm')?.addEventListener('submit', function () {
  var btn = document.getElementById('infantSubmitBtn');
  if (btn) {
    btn.disabled = true;
...
<?php if ($success): ?>
document.getElementById('infantForm')?.reset();
<?php endif; ?>
</script>
    </main>
  </div>
