...
<div class="bhms-shell">
  ...
  <div class="bhms-main">
    <header class="bhms-topbar">
      ...
      <div class="bhms-topbar-title">Prenatal Checkups</div>
...
<div class="container py-4">
  <div class="d-flex justify-content-between align-items-center mb-4">
    <h3><i class="fa-solid fa-stethoscope me-2" style="color:var(--bhms-green);"></i>Prenatal checkups — <?= htmlspecialchars($record['first_name'] . ' ' . $record['last_name']) ?></h3>
  ...
  <div class="card mb-4">
    <div class="card-body">
      <h5 class="card-title"><i class="fa-solid fa-notes-medical me-2"></i>Record a checkup</h5>
      <form method="POST" action="">
        ...
        <button type="submit" class="btn btn-primary mt-3"><i class="fa-solid fa-plus me-2"></i>Add checkup</button>
      </form>
    </div>
  </div>

  <h5><i class="fa-solid fa-clock-rotate-left me-2"></i>Checkup history</h5>
  <div class="checkups-table-card">
