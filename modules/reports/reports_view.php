...
.bhms-nav::-webkit-scrollbar-button:vertical:end:increment {
  ...
  .summary-table td:last-child { font-weight: 700; color: var(--bhms-blue-dark); text-align: right; }
</style>
</head>
...
<div class="container py-4">
  <div class="d-flex justify-content-between align-items-center mb-4">
    <h3><i class="fa-solid fa-file-lines me-2" style="color:var(--bhms-blue);"></i>Reports Generation</h3>
